...
pub unsafe extern "C" fn call_finishing_hit_effects(defender_boma: &mut BattleObjectModuleAccessor) {
    let handle = EffectModule::req_screen(defender_boma, Hash40::new("bg_finishhit"), false, false, false);
    EffectModule::set_billboard(defender_boma, handle as u32, false);
    ...
    VarModule::set_int(defender_boma.object(), COUNTER, 20);
    SlowModule::set_whole(defender_boma, 0, 0);
